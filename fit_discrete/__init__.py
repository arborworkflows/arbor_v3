...
from fit_discrete.methods import *
import rpy2
...
def init(app):
    ...
    @app.get('/fit_discrete')
    def index():
        with open('fit_discrete/index.html') as indexFile:
    ...
    @app.post('/fit_discrete/table_upload')
    ...
    @app.post('/fit_discrete/tree_upload')
    ...
    async def run(params : Request):
        ...
        print('run with transformation:',params_obj['transform'])
