...
def init(app):
    ...
    @app.get('/asr')
    def index():
        with open('asr/index.html') as indexFile:
    ...
    async def run(params : Request):
        ...
        print('run with column:',params_obj['selColumn'])
